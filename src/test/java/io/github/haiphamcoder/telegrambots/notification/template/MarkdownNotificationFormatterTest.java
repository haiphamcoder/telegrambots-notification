...
/**
 * Unit tests for MarkdownNotificationFormatter.
 */
class MarkdownNotificationFormatterTest {

    private MarkdownNotificationFormatter formatter;
    ...
    @Test
    void testMode() {
        assertEquals(ParseMode.MARKDOWN, formatter.mode());
    }
    ...
    void testCustomTemplates() {
        ...
        MarkdownNotificationFormatter customFormatter = new MarkdownNotificationFormatter(customTemplates);
