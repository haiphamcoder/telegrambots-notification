...
/**
 * Provides default Markdown templates for different notification severity levels.
 * These templates are designed to work with Telegram's Markdown parse mode.
 */
public final class DefaultMarkdownTemplates {
    ...
    private DefaultMarkdownTemplates() {
        // Utility class - prevent instantiation
    }

    /**
     * Gets the Markdown template for the specified severity level.
     *
     * @param severity the severity level
     * @return the Markdown template string
     ...
     *
     * @return a map of severity levels to their corresponding Markdown templates
     */
