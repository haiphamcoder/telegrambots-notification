...
/**
 * Utility class for escaping MarkdownV2 content to be safely used in Telegram MarkdownV2 messages.
 * This class provides methods to escape special MarkdownV2 characters and format context data.
...
public final class MarkdownV2Escaper {
    ...
    /**
     * Escapes MarkdownV2 special characters in the given string for text content.
     * Escapes: _ * [ ] ( ) ~ ` > # + - = | { } . !
     *
    ...
    /**
     * Escapes MarkdownV2 special characters in the given string for code content.
    ...
    /**
     * Escapes and formats a timestamp for display in MarkdownV2.
     *
